...
import game from '../delta-force';
import type { Axis } from '../types';

// ── Structural checks ─────────────────────────────────────────────────────────

describe('Delta Force question structure', () => {
...
/**
 * Build an answer set that maximises votes toward a target polarity on each
 * dominant axis. For each question, pick the option whose scoring vector
 * contributes the most positive or negative net score toward the target
 * pattern on the 3 dominant axes.
 */
...
describe('Delta Force archetype reachability', () => {
